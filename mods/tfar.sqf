...
_settingsSwGuer set [2, ["31.00","31.10","31.20","31.30","31.40","31.50"]];
...
_settingsSwEast set [2, ["31.00","31.10","31.20","31.30","31.40","31.50"]];
...
if (player == leader group player || ["TL",(typeOf player)] call BIS_fnc_inString) then {
	_secondaryChannel = 0;
};
