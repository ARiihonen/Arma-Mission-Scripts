...
{
    case "Balavu": { _evidence = evidenceBalavu; _targets = targetsBalavu; };
    case "Lijnhaven": { _evidence = evidenceLijnhaven; _targets = targetsLijnhaven; };
    case "Bluepearl": { _evidence = evidenceBluepearl; _targets = targetsBluepearl; };
    case "Roadhouse": { _evidence = evidenceRoadhouse; _targets = targetsRoadhouse; };
};
